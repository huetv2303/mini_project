                  ...
                  <div className="flex">
                    ...
                    >
                      <div className="flex-shrink-0 mt-1">
                        <div
                          className={`h-11 w-11 rounded-xl flex items-center justify-center text-xl shadow-sm ${
                            notification.data?.color === "red"
                              ? "bg-red-50 text-red-500"
                              : notification.data?.color === "green"
                                ? "bg-green-50 text-green-500"
                                : "bg-blue-50 text-blue-500"
                          }`}
                        >
                          {notification.data?.icon ||
                            (notification.data?.type === "review_replied"
                              ? "💬"
                              : "🔔")}
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                          <p
                            className={`text-sm font-bold truncate ${!notification.read_at ? "text-slate-900" : "text-slate-500"}`}
                          >
